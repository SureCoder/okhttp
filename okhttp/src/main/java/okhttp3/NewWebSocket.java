...
/**
 * A non-blocking interface to a web socket. Use the {@link NewWebSocket.Factory factory} to create
...
public interface NewWebSocket {
  ...
  abstract class Listener {
    ...
    /**
     * Invoked when a web socket has been violently closed. Both outgoing and incoming messages may
